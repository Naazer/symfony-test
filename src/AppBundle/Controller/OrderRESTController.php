...
class OrderRESTController extends VoryxController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('AppBundle:Order')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                return $entities;
            }
    ...
    {
        $entity = new Order();
        $form = $this->createForm(new OrderType(), $entity, array("method" => $request->getMethod()));
    ...
    /**
     * Partial Update to a Order entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
*/
    public function patchAction(Request $request, Order $entity)
    {
